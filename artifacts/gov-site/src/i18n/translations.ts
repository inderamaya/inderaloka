  ...
  ms: {
    ...
    royal: {
      ...
      orders: {
        ...
        pageDesc: "Panduan rasmi susunan, taraf, syarat penganugerahan, gelaran, dan pemakaian darjah kebesaran, bintang kehormatan, pingat dan tauliah Negara Inderaloka.",
        intro: "Segala kurniaan adalah tertakluk kepada titah perkenan Kebawah Duli Yang Maha Mulia Paduka Seri Baginda Sultan Inderaloka, adat istiadat negara, Undang-Undang Tubuh Kerajaan Inderaloka dan peraturan yang berkuat kuasa.",
        purposeTitle: "1. Tujuan",
        purposeBody: "Panduan ini menetapkan susunan, taraf, syarat penganugerahan, gelaran, singkatan, pemakaian dan ketetapan am bagi darjah kebesaran, bintang kehormatan, pingat dan tauliah Negara Inderaloka.",
        generalProvisionsTitle: "2. Ketetapan Am",
        generalProvisions: [
          { title: "2.1 Kuasa Kurniaan", desc: "Segala darjah kebesaran, bintang kehormatan, pingat dan tauliah Negara Inderaloka dikurniakan atas titah perkenan Kebawah Duli Yang Maha Mulia Paduka Seri Baginda Sultan Inderaloka.\n\nPenganugerahan boleh dibuat sempena Hari Keputeraan Sultan, istiadat kebesaran negara, pertabalan, jubli pemerintahan, upacara khas negara atau pada bila-bila masa yang diperkenankan oleh Sultan." },
          { title: "2.2 Pelucutan, Pembatalan dan Penggantungan", desc: "Sesuatu darjah kebesaran, bintang kehormatan, pingat atau tauliah boleh dilucutkan, dibatalkan atau digantung atas titah perkenan Sultan apabila penerima:\n1. menderhaka kepada Takhta;\n2. disabitkan atas kesalahan jenayah berat;\n3. melanggar sumpah taat setia;\n4. melakukan perbuatan yang menjejaskan martabat kurniaan; atau\n5. melakukan apa-apa perbuatan yang pada hemat Sultan tidak selaras dengan kehormatan kurniaan berkenaan." },
          { title: "2.3 Penganugerahan Anumerta", desc: "Sesuatu darjah kebesaran, bintang kehormatan atau pingat boleh dikurniakan secara anumerta kepada seseorang yang telah mangkat atau meninggal dunia sekiranya jasa, pengorbanan atau khidmat baktinya kepada Raja dan Negara dinilai luar biasa dan wajar diabadikan dalam rekod kehormatan negara." },
          { title: "2.4 Gelaran Pasangan", desc: "Isteri kepada penerima lelaki yang dikurniakan gelaran tertentu boleh menggunakan gelaran pasangan sebagaimana yang ditetapkan bagi darjah berkenaan. Suami kepada penerima wanita tidak membawa gelaran pasangan." },
          { title: "2.5 Susunan Pemakaian", desc: "Pemakaian darjah kebesaran, bintang kehormatan dan pingat hendaklah mengikut susunan keutamaan yang ditetapkan dalam panduan ini atau mana-mana peraturan pemakaian yang diperkenankan oleh Sultan." },
        ],
        parts: [
          {
            id: "part1",
            ...
            items: [
              {
                ...
                details: [
                  ...
                  { label: "Reben", value: "Merah Darah dengan jalur tegak Hitam di bahagian tengah" },
                  { label: "Elaun", value: "₭10,000 sebulan (Hidup) / ₭100,000 sekali gus (Waris Anumerta)" },
                ],
              },
            ],
          },
            ...
            items: [
              {
                ...
                ranks: [
                  { name: "Pangkat Pertama (D.K. I)", eligible: "Sultan, Permaisuri, Tunku Mahkota, Waris Damping dan Pasangan", title: "Tiada Gelaran" },
                  { name: "Pangkat Kedua (D.K. II)", eligible: "Kerabat Diraja Inderaloka, Raja-raja Pemerintah asing, dan kerabat diraja asing", title: "Tiada Gelaran" },
                ],
              },
            ],
          },
            ...
            items: [
              {
                ...
                ribbon: "Putih Gading dengan jalur tengah Kuning Diraja dan jalur tepi Merah Darah",
                ranks: [
                  { name: "Seri Maharaja Cendera Alam (S.M.C.A.)", title: "Tun (Isteri: Toh Puan)", limit: "25 orang" },
                  { name: "Panglima Seri Cendera Alam (P.S.C.A.)", title: "Tan Sri (Isteri: Puan Sri)", limit: "75 orang" },
                ],
              },
              {
                ...
                ranks: [
                  { name: "Seri Utama Cura Si Gilang Sari (S.C.G.S.)", title: "Dato’ Seri Utama (Isteri: Datin Seri Utama)", limit: "35 orang" },
                  { name: "Panglima Cura Si Gilang Sari (P.C.G.S.)", title: "Dato’ Utama (Isteri: Datin Utama)", limit: "75 orang" },
                  { name: "Ahli Cura Si Gilang Sari (A.C.G.S.)", title: "Tiada Gelaran", limit: "Tiada Had" },
                ],
              },
              {
                ...
                ranks: [
                  { name: "Seri Setia Mangku Negara (S.S.M.N.)", title: "Dato’ Seri Setia (Isteri: Datin Seri Setia)", limit: "150 orang" },
                  { name: "Panglima Setia Mangku Negara (P.S.M.N.)", title: "Dato’ Setia (Isteri: Datin Setia)", limit: "200 orang" },
                  { name: "Johan Setia Mangku Negara (J.S.M.N.)", title: "Tiada Gelaran", limit: "450 orang" },
                  { name: "Kesatria Setia Mangku Negara (K.S.M.N.)", title: "Tiada Gelaran", limit: "800 orang" },
                  { name: "Ahli Setia Mangku Negara (A.S.M.N.)", title: "Tiada Gelaran", limit: "200 orang setahun" },
                ],
              },
              {
                ...
                ranks: [
                  { name: "Seri Bahaduri Paduka Inderawangsa (S.B.P.I.)", title: "Dato’ Seri (Isteri: Datin Seri)", limit: "50 orang" },
                  { name: "Panglima Bahaduri Paduka Inderawangsa (P.B.P.I.)", title: "Dato’ (Isteri: Datin)", limit: "150 orang" },
                  { name: "Johan Bahaduri Paduka Inderawangsa (J.B.P.I.)", title: "Tiada Gelaran", limit: "450 orang" },
                  { name: "Ahli Bahaduri Paduka Inderawangsa (A.B.P.I.)", title: "Tiada Gelaran", limit: "200 orang setahun" },
                ],
              },
            ],
          },
            ...
            items: [
              {
                ...
                ranks: [
                  { name: "Seri Pahlawan Angkatan Tentera (S.P.A.T.)", title: "Dato’ Seri Pahlawan (Isteri: Datin Seri Pahlawan)", limit: "30 orang" },
                  { name: "Pahlawan Angkatan Tentera (P.A.T.)", title: "Dato’ Pahlawan (Isteri: Datin Pahlawan)", limit: "150 orang" },
                  { name: "Hulubalang Angkatan Tentera (H.A.T.)", title: "Tiada Gelaran", limit: "Tiada Had" },
                ],
              },
              {
                ...
                ranks: [
                  { name: "Seri Perwira Pasukan Polis (S.P.P.P.)", title: "Dato’ Seri Wira (Isteri: Datin Seri Wira)", limit: "30 orang" },
                  { name: "Perwira Pasukan Polis (P.P.P.)", title: "Dato’ Wira (Isteri: Datin Wira)", limit: "150 orang" },
                  { name: "Hulubalang Pasukan Polis (H.P.P.)", title: "Tiada Gelaran", limit: "Tiada Had" },
                ],
              },
            ],
          },
            ...
            items: [
              {
                ...
                ranks: [
                  { name: "Pingat Gagah Perkasa Emas (P.G.P.E.)", reward: "₭7,000 sebulan / ₭70,000 (Anumerta)" },
                  { name: "Pingat Gagah Perkasa Perak (P.G.P.P.)", reward: "₭5,000 sebulan / ₭50,000 (Anumerta)" },
                  { name: "Pingat Gagah Perkasa Gangsa (P.G.P.G.)", reward: "₭3,000 sebulan / ₭30,000 (Anumerta)" },
                ],
              },
            ],
          },
          {
            ...
            items: [
              { name: "12. Pingat Khidmat Cemerlang (P.K.C.)", desc: "Pengiktirafan prestasi kerja cemerlang, dedikasi berterusan dan sumbangan melebihi tuntutan tugas biasa." },
              { name: "13. Pingat Jasa Kebaktian (P.J.K.)", desc: "Pengiktirafan khidmat bakti yang lama (min. 18 tahun), bersih dan berterusan kepada Raja dan Negara." },
              { name: "14. Pingat Budi Teladan (P.B.T.)", desc: "Dikurniakan kepada individu yang menunjukkan kelakuan amat terpuji, amanah, berintegriti dan menjadi teladan." },
            ],
          },
          {
            id: "part7",
            ...
            items: [
              { name: "15. Pingat Kedaulatan Wilayah (P.K.W.)", desc: "Pingat kempen bagi mengiktiraf perkhidmatan (min. 30 hari) dalam zon operasi mempertahankan kedaulatan sempadan." },
              {
                ...
                categories: [
                  { label: "Tentera Darat", value: "Pingat Laskar Buana (P.L.B.)" },
                  { label: "Tentera Laut", value: "Pingat Laskar Samudera (P.L.S.)" },
                  { label: "Tentera Udara", value: "Pingat Laskar Jumantara (P.L.J.)" },
                ],
              },
              { name: "17. Pingat Pertabalan Sultan Abdul Aziz Shah", desc: "Dikurniakan sempena Istiadat Pertabalan KDYMM Sultan Abdul Aziz Shah. Varian: Emas & Perak." },
              { name: "18. Pingat Jubli Perak Sultan Abdul Aziz Shah", desc: "Dikurniakan sempena genap 25 tahun pemerintahan KDYMM Sultan Abdul Aziz Shah." },
              { name: "19. Pingat Pertabalan Sultan Ibrahim Shah", desc: "Dikurniakan sempena Istiadat Pertabalan KDYMM Sultan Ibrahim Shah. Varian: Emas & Perak." },
            ],
          },
          {
            id: "part8",
        ...
        precedenceHeaders: ["Bil.", "Anugerah / Pangkat", "Singkatan", "Gelaran"],
        precedenceItems: [
          ["1", "Bintang Mahkota Pejuang Pertiwi", "B.M.P.P.", "Pejuang Pertiwi"],
          ["2", "Darjah Kerabat Inderaloka Yang Agung Pangkat Pertama", "D.K. I", "-"],
          ["3", "Darjah Kerabat Inderaloka Yang Agung Pangkat Kedua", "D.K. II", "-"],
          ["4", "Seri Maharaja Cendera Alam", "S.M.C.A.", "Tun"],
          ["5", "Panglima Seri Cendera Alam", "P.S.C.A.", "Tan Sri"],
          ["6", "Seri Utama Cura Si Gilang Sari", "S.C.G.S.", "Dato’ Seri Utama"],
          ["7", "Seri Setia Mangku Negara", "S.S.M.N.", "Dato’ Seri Setia"],
          ["8", "Seri Bahaduri Paduka Inderawangsa", "S.B.P.I.", "Dato’ Seri"],
          ["9", "Seri Pahlawan Angkatan Tentera", "S.P.A.T.", "Dato’ Seri Pahlawan"],
        ...
        footerNote: "Bagi darjah yang membawa gelaran kepada penerima lelaki, gelaran pasangan bagi isteri penerima lelaki adalah sebagaimana yang ditetapkan dalam bahagian darjah masing-masing.",
  ...
  en: {
    ...
    history: {
      ...
      eras: [
        ...
        },
        {
          year: "1890 – 1963",
          label: "AWAKENING",
          title: "The Era of Modernisation and the Struggle for Self-Government",
    ...
    royal: {
      ...
      orders: {
        ...
        pageDesc: "The official guide for the order of precedence, status, award criteria, titles, and wearing of the orders, decorations, medals and commissions of the State of Inderaloka.",
        intro: "All honours are subject to the decree and consent of His Majesty the Sultan of Inderaloka, national customs, the Constitution of Inderaloka, and current regulations.",
        purposeTitle: "1. Purpose",
        purposeBody: "This guide establishes the order, status, award criteria, titles, abbreviations, wearing, and general provisions for the orders, decorations, medals, and commissions of the State of Inderaloka.",
        generalProvisionsTitle: "2. General Provisions",
        generalProvisions: [
          { title: "2.1 Awarding Power", desc: "All orders, decorations, medals, and commissions of the State of Inderaloka are conferred at the decree and consent of His Majesty the Sultan of Inderaloka.\n\nInvestitures may be held in conjunction with the Sultan's Birthday, state ceremonies, coronations, ruling jubilees, special state occasions, or at any time as approved by the Sultan." },
          { title: "2.2 Stripping, Cancellation and Suspension", desc: "An order, decoration, medal, or commission may be stripped, cancelled, or suspended at the Sultan's decree when the recipient:\n1. commits treason against the Throne;\n2. is convicted of a serious criminal offence;\n3. violates the oath of loyalty;\n4. acts in a manner that tarnishes the dignity of the honour; or\n5. performs any act which in the Sultan's judgement is inconsistent with the honour concerned." },
          { title: "2.3 Posthumous Awards", desc: "An order, decoration, or medal may be awarded posthumously to an individual who has passed away if their service, sacrifice, or dedication to the King and State is judged extraordinary and worthy of being immortalised in the national honour record." },
          { title: "2.4 Spousal Titles", desc: "The wife of a male recipient who is awarded a specific title may use the corresponding spousal title as established for that order. The husband of a female recipient does not carry a spousal title." },
          { title: "2.5 Wearing Order", desc: "The wearing of orders, decorations, and medals shall follow the order of precedence established in this guide or any wearing regulations approved by the Sultan." },
        ],
        parts: [
          {
            id: "part1",
            ...
            items: [
              {
                ...
                details: [
                  ...
                  { label: "Ribbon", value: "Blood Red with a vertical Black stripe in the centre" },
                  { label: "Allowance", value: "₭10,000 monthly (Living) / ₭100,000 lump sum (Posthumous Next-of-Kin)" },
                ],
              },
            ],
          },
            ...
            items: [
              {
                ...
                ranks: [
                  { name: "First Class (D.K. I)", eligible: "The Sultan, Queen, Crown Prince, Heir Presumptive and Consorts", title: "No Title" },
                  { name: "Second Class (D.K. II)", eligible: "Inderaloka Royal Family, foreign Ruling Monarchs, and foreign royalty", title: "No Title" },
                ],
              },
            ],
          },
            ...
            items: [
              {
                ...
                ribbon: "Ivory White with a Royal Yellow centre stripe and Blood Red edge stripes",
                ranks: [
                  { name: "Seri Maharaja Cendera Alam (S.M.C.A.)", title: "Tun (Wife: Toh Puan)", limit: "25 persons" },
                  { name: "Panglima Seri Cendera Alam (P.S.C.A.)", title: "Tan Sri (Wife: Puan Sri)", limit: "75 persons" },
                ],
              },
              {
                name: "6. Darjah Cura Si Gilang Sari Yang Maha Utama",
                ...
                ranks: [
                  { name: "Seri Utama Cura Si Gilang Sari (S.C.G.S.)", title: "Dato’ Seri Utama (Wife: Datin Seri Utama)", limit: "35 persons" },
                  { name: "Panglima Cura Si Gilang Sari (P.C.G.S.)", title: "Dato’ Utama (Wife: Datin Utama)", limit: "75 persons" },
                  { name: "Ahli Cura Si Gilang Sari (A.C.G.S.)", title: "No Title", limit: "No Limit" },
                ],
              },
              {
                name: "7. Darjah Setia Mangku Negara Yang Amat Terpuji",
                ...
                ranks: [
                  { name: "Seri Setia Mangku Negara (S.S.M.N.)", title: "Dato’ Seri Setia (Wife: Datin Seri Setia)", limit: "150 persons" },
                  { name: "Panglima Setia Mangku Negara (P.S.M.N.)", title: "Dato’ Setia (Wife: Datin Setia)", limit: "200 persons" },
                  { name: "Johan Setia Mangku Negara (J.S.M.N.)", title: "No Title", limit: "450 persons" },
                  { name: "Kesatria Setia Mangku Negara (K.S.M.N.)", title: "No Title", limit: "800 persons" },
                  { name: "Ahli Setia Mangku Negara (A.S.M.N.)", title: "No Title", limit: "200 persons annually" },
                ],
              },
              {
                name: "8. Darjah Bahaduri Paduka Inderawangsa Yang Amat Luhur",
                ...
                ranks: [
                  { name: "Seri Bahaduri Paduka Inderawangsa (S.B.P.I.)", title: "Dato’ Seri (Wife: Datin Seri)", limit: "50 persons" },
                  { name: "Panglima Bahaduri Paduka Inderawangsa (P.B.P.I.)", title: "Dato’ (Wife: Datin)", limit: "150 persons" },
                  { name: "Johan Bahaduri Paduka Inderawangsa (J.B.P.I.)", title: "No Title", limit: "450 persons" },
                  { name: "Ahli Bahaduri Paduka Inderawangsa (A.B.P.I.)", title: "No Title", limit: "200 persons annually" },
                ],
              },
            ],
          },
            ...
            items: [
              {
                ...
                ranks: [
                  { name: "Seri Pahlawan Angkatan Tentera (S.P.A.T.)", title: "Dato’ Seri Pahlawan (Wife: Datin Seri Pahlawan)", limit: "30 persons" },
                  { name: "Pahlawan Angkatan Tentera (P.A.T.)", title: "Dato’ Pahlawan (Wife: Datin Pahlawan)", limit: "150 persons" },
                  { name: "Hulubalang Angkatan Tentera (H.A.T.)", title: "No Title", limit: "No Limit" },
                ],
              },
              {
                name: "10. Darjah Perwira Pasukan Polis Inderaloka",
                ...
                ranks: [
                  { name: "Seri Perwira Pasukan Polis (S.P.P.P.)", title: "Dato’ Seri Wira (Wife: Datin Seri Wira)", limit: "30 persons" },
                  { name: "Perwira Pasukan Polis (P.P.P.)", title: "Dato’ Wira (Wife: Datin Wira)", limit: "150 persons" },
                  { name: "Hulubalang Pasukan Polis (H.P.P.)", title: "No Title", limit: "No Limit" },
                ],
              },
            ],
          },
            ...
            items: [
              {
                ...
                ranks: [
                  { name: "Pingat Gagah Perkasa Emas (P.G.P.E.)", reward: "₭7,000 monthly / ₭70,000 (Posthumous)" },
                  { name: "Pingat Gagah Perkasa Perak (P.G.P.P.)", reward: "₭5,000 monthly / ₭50,000 (Posthumous)" },
                  { name: "Pingat Gagah Perkasa Gangsa (P.G.P.G.)", reward: "₭3,000 monthly / ₭30,000 (Posthumous)" },
                ],
              },
            ],
          },
          {
            ...
            items: [
              { name: "12. Pingat Khidmat Cemerlang (P.K.C.)", desc: "Recognition of excellent work performance, continuous dedication, and contributions beyond the call of duty." },
              { name: "13. Pingat Jasa Kebaktian (P.J.K.)", desc: "Recognition of long (min. 18 years), clean, and continuous service to the King and State." },
              { name: "14. Pingat Budi Teladan (P.B.T.)", desc: "Conferred upon individuals who display highly commendable conduct, trustworthiness, integrity, and serve as role models." },
            ],
          },
          {
            id: "part7",
            ...
            items: [
              { name: "15. Pingat Kedaulatan Wilayah (P.K.W.)", desc: "Campaign medal to recognise service (min. 30 days) in designated operational zones defending border sovereignty." },
              {
                name: "16. Pingat Laskar Angkatan Inderaloka",
                ...
                categories: [
                  ...
                  { label: "Air Force", value: "Pingat Laskar Jumantara (P.L.J.)" },
                ],
              },
              { name: "17. Pingat Pertabalan Sultan Abdul Aziz Shah", desc: "Conferred in conjunction with the Installation Ceremony of HM Sultan Abdul Aziz Shah. Variants: Gold & Silver." },
              { name: "18. Pingat Jubli Perak Sultan Abdul Aziz Shah", desc: "Conferred in conjunction with the 25th anniversary of the reign of HM Sultan Abdul Aziz Shah." },
              { name: "19. Pingat Pertabalan Sultan Ibrahim Shah", desc: "Conferred in conjunction with the Installation Ceremony of HM Sultan Ibrahim Shah. Variants: Gold & Silver." },
            ],
          },
          {
            id: "part8",
        ...
        precedenceItems: [
          ["1", "Bintang Mahkota Pejuang Pertiwi", "B.M.P.P.", "Pejuang Pertiwi"],
          ["2", "Darjah Kerabat Inderaloka Yang Agung First Class", "D.K. I", "-"],
          ["3", "Darjah Kerabat Inderaloka Yang Agung Second Class", "D.K. II", "-"],
          ["4", "Seri Maharaja Cendera Alam", "S.M.C.A.", "Tun"],
          ["5", "Panglima Seri Cendera Alam", "P.S.C.A.", "Tan Sri"],
          ["6", "Seri Utama Cura Si Gilang Sari", "S.C.G.S.", "Dato’ Seri Utama"],
          ["7", "Seri Setia Mangku Negara", "S.S.M.N.", "Dato’ Seri Setia"],
        ...
        footerNote: "For orders that carry a title for male recipients, the spousal title for the wife of a male recipient is as established in their respective order sections.",
