            ...
            <div className="relative p-2 border border-border bg-white shadow-xl mb-6">
              <div className="aspect-[3/4] bg-primary/5 border border-border flex items-center justify-center relative overflow-hidden group">
                ...
                <div className="text-center z-10">
                  <div className="w-16 h-16 border border-accent mx-auto mb-3 flex items-center justify-center bg-white">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-16">
            ...
            <div className="relative w-full md:w-80">
              ...
              <Input 
                ...
                className="pl-10 border-border bg-white focus:ring-accent"
                value={searchTerm}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
            {filteredArchive.map((pm, idx) => (
              <motion.div
                ...
                className="border border-border bg-white group hover:border-accent/40 transition-all shadow-sm hover:shadow-md overflow-hidden"
              >
                <div className="aspect-[4/3] bg-secondary flex items-center justify-center relative overflow-hidden border-b border-border">
                  ...
                  <div className="z-10 text-center">
                    <div className="w-14 h-14 border border-accent/40 mx-auto mb-3 flex items-center justify-center bg-white rounded-full">
                ...
                <div className="p-6">
                  ...
                  <button
                    ...
                    className="w-full py-2 border border-border text-[10px] font-mono uppercase tracking-widest hover:bg-primary hover:text-white transition-all flex items-center justify-center gap-2"
                  >
                    ...
                    >
                      <div className="p-6 border-t border-border space-y-6">
                        ...
                        <div className="pt-4 border-t border-border/50">
                          ...
                          <div className="h-16 bg-white/50 border border-dashed border-border flex items-center justify-center italic text-muted-foreground/30 font-serif text-sm">
                            [ Signature: {pm.name} ]
                          </div>
                        </div>
                      </div>
              ...
              {p.pmArchive.flatMap(pm => pm.milestones).map((m, idx) => (
                ...
                >
                  ...
                  <div className={`ml-12 md:ml-0 w-full md:w-1/2 ${idx % 2 === 0 ? "md:pr-12" : "md:pl-12"}`}>
                    <div className="p-5 border border-border bg-white shadow-sm relative">
