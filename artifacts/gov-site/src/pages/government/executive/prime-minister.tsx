        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          >
            ...
            <div className="mt-4 border border-accent/30 bg-accent/5 p-4">
              ...
              <p className="text-sm text-primary font-light italic leading-relaxed">"{p.motto}"</p>
            </div>
          </motion.div>
          ...
          >
            <div className="mb-12">
              <h2 className="font-serif text-2xl text-primary mb-4">{p.roleTitle}</h2>
              <div className="w-12 h-px bg-accent mb-6" />
              <p className="text-muted-foreground leading-relaxed font-light">{p.roleBody}</p>
            </div>

            <div>
              <h2 className="font-serif text-2xl text-primary mb-4">{p.dutiesTitle}</h2>
              <div className="w-12 h-px bg-accent mb-6" />
