      ...
      <div className="container mx-auto px-4 lg:px-8 pt-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {l.subpages.map((sub, idx) => (
            ...
            >
              <Link href={sub.href} className="group block border border-border bg-background hover:border-accent transition-colors p-8">
                ...
                <h2 className="font-serif text-2xl text-primary mb-3 group-hover:text-accent transition-colors">{sub.title}</h2>
