    ...
    <div className="flex-1 w-full bg-background pb-24">
      <div className="bg-secondary border-b border-border py-12">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <h1 className="font-serif text-4xl lg:text-5xl text-primary mb-6">{j.pageTitle}</h1>
          <p className="text-muted-foreground text-lg max-w-2xl font-light">{j.pageDesc}</p>
        </div>
      </div>
