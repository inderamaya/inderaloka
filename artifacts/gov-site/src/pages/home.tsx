        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
            <div>
              ...
              <h3 className="font-serif text-4xl text-primary">{h.sectionTitle}</h3>
            </div>
            ...
            <div className="lg:col-span-2 flex flex-col">
              {h.latestNews.map((news, idx) => (
                <motion.div
                  ...
                  transition={{ duration: 0.5, delay: idx * 0.1 }}
                >
                  <Link href="/news" className="group block py-8 border-b border-border hover:border-accent transition-colors first:pt-0" data-testid={`link-news-${idx}`}>
