...
import { ChevronRight, MapPin, Camera, Info } from "lucide-react";
    ...
    <div className="flex-1 w-full bg-background relative overflow-hidden">
            ...
            {tr.destinations.map((dest: any, idx: any) => (
              ...
              >
                ...
                <Link href="#" className="inline-flex items-center text-xs font-mono uppercase tracking-widest text-accent hover:text-primary transition-colors">
                  Detail Destinasi <ChevronRight className="ml-1 w-3 h-3" />
                </Link>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-24 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="font-serif text-4xl lg:text-6xl mb-8 italic">Mula Rancang Perjalanan Anda</h2>
